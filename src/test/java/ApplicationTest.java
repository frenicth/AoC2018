...
class ApplicationTest {
    ...
    @ParameterizedTest
    @MethodSource("incompleteLinesOfChunks")
    void testScoreForIncompleteLinesOfChunks(List<String> input, long expected) {
    ...
    private static Stream<Arguments> incompleteLinesOfChunks() {
        return Stream.of(
                Arguments.of(List.of("[({(<(())[]>[[{[]{<()<>>",
                        "[(()[<>])]({[<{<<[]>>(",
                        "{([(<{}[<>[]}>{[]{[(<()>",
